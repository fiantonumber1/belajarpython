...
#######
#######
####### Soal dapat dilihat pada file: Soal Tugas Pengganti UTS Komputasi Vibrasi 2022.pdf
#######
#######
...
Edof = np.array([
    ...
    [9,10,13,14], #element 9
    [11,12,13,14], #element 10
])

K = np.matrix(np.zeros((14,14))) # matrix 14 x 14
f = np.matrix(np.zeros((14,1))) # there are 7 node. 1 node has x and y so there are 14 point
...
ep9 = [E,A]   # element properties element 9
ep10 = [E,A]   # element properties element 10
...
ex9 = np.array([80, 120])     # element cordinat (x) for element 9
ex10 = np.array([80, 120])     # element cordinat (x) for element 10
...
ey9 = np.array([0., 0.])     # element cordinat (y) for element 8
ey10 = np.array([40, 0.])     # element cordinat (y) for element 8
...
Ke9 = cfc.bar2e(ex9,ey9,ep9) #Element stiffness matrices for element 9
Ke10 = cfc.bar2e(ex10,ey10,ep10) #Element stiffness matrices for element 10
...
cfc.assem(Edof[8,:],K,Ke9)   #Assemble Ke9 into K
cfc.assem(Edof[9,:],K,Ke10)   #Assemble Ke10 into K
...
f[9] =  -2000    #force input in U10
f[10] = 1000    #force input in U11
f[11] = 3000    #force input in U12
f[12] = 3000    #force input in U13
f[13] = -1000    #force input in U14
...
ed9 = cfc.extractEldisp(Edof[8,:],a);
N9 = cfc.bar2s(ex9,ey9,ep9,ed9)
ed10 = cfc.extractEldisp(Edof[9,:],a);
N10 = cfc.bar2s(ex10,ey10,ep10,ed10)
...
print("N9=",N10) #Element forces in element 9
print("N10=",N10) #Element forces in element 10