...
line1, = plt.plot([0] + times.tolist(), ref, label='belum terlabel')
line2, = plt.plot([0] + times.tolist(), feedback, label='belum terlabel')
...
# plot u
plt.figure(figsize=(10,7))
plt.plot([0] + times.tolist(), u, label='belum terlabel')
plt.legend()
plt.grid()
...
# plot error
plt.figure(figsize=(10,7))
plt.plot([0] + times.tolist(), error, label='belum terlabel')
plt.legend()
plt.grid()
