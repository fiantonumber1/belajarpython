...
while y == 0:
    ...
    layout = [[sg.Text(f"Anggota Kelompok ")],
              ...
              [sg.Text(f"", size=(15, 1))],
              [sg.Text(f"Metode Ziegler-Nichols", size=(30, 1)), sg.Text(f"", size=(15, 1)),
               sg.Text(f"Tanpa Metode Tunning", size=(30, 1))],
              ...
              [sg.InputText(key='Massa_tunning', size=(15, 1)), sg.Text(f"", size=(32, 1)),
               sg.InputText(key='Ti_manual')],
              [sg.Text('Frict (Nm/s)', size=(15, 1)), sg.Text(f"", size=(30, 1)), sg.Text('Td', size=(15, 1))],
              [sg.InputText(key='Friction_tunning', size=(15, 1)), sg.Text(f"", size=(32, 1)),
               sg.InputText(key='Td_manual')],
              [sg.Text('Pilihan Controller', size=(15, 1)), sg.Text(f"", size=(30, 1)),
               sg.Text('Massa(kg)', size=(15, 1))],
              [sg.Combo(pilihan, size=(15, 1), key='pilihan_controller'), sg.Text(f"", size=(30, 1)),
               sg.InputText(key='Massa_manual')],
              [sg.Text(f'Metode Ziegler-Nichols', size=(20, 1)), sg.Text(f"", size=(25, 1)),
               sg.Text('Friction(Nm/s)', size=(15, 1))],
              [sg.Text(f'controller: [Kp, Ti, Td]', size=(20, 1)), sg.Text(f"", size=(25, 1)),
               sg.InputText(key='Friction_manual')],
    ...
    for t in tqdm(times):
        ...
        feedback[t] = car_dynamics(b=frict, v_in=feedback[t - 1], u=u[t], m=mass,
                                   dt=t - t_prev)  # calculate model output #feedback = kecepatan baru (m/s)
    ...
    for t in tqdm(times):
        ...
        feedback[t] = car_dynamics(b=frict, v_in=feedback[t - 1], u=u[t], m=mass,
                                   dt=t - t_prev)  # calculate model output #kumpulan kecepatan
        t_prev = t  # store for next iteration
