...
file_path = 'All_Document_Report_1722483299.xlsx'  # Ganti dengan path ke file Excel Anda
...
if 'C' in df.columns:
    ...
    with pd.ExcelWriter(output_file_path, engine='openpyxl') as writer:
        ...
        df_td.to_excel(writer, sheet_name='PT', index=False)

    print(f'File Excel baru dengan sheet "PI", "FC", "FP", "TD" dan "PT" telah disimpan sebagai {output_file_path}.')
else:
    print('Kolom "C" tidak ditemukan dalam DataFrame.')
