    ...
    if Username == "admin" and Password == "1234":
        ...
        def struk():
            ...
            if thsa:
                ...
                textStruk.insert(END, f"Bayar\t\t\tRp. {subtotalItems+totaltax}\n\n")
                textStruk.insert(END, f"Kembalian\t\t\tRp. {subtotalItems+totaltax}\n\n")
        ...
        def reset():
            ...
            textbayar.config(state=DISABLED)
        ...
        def bayar():
            global clickedbayar
            if clickedbayar == False:
                varbayar.set(1)
                textbayar.config(state=NORMAL)
                textbayar.delete(0, END)
                textbayar.focus()
                clickedbayar = True
            else:
                varbayar.set(0)
        ...
        textbayar = Entry(
            ...
            width=7,
            state=DISABLED,
            textvariable = bayarvar,
        )
        textbayar.grid(row=8, column=2)
